...
/* Options : - OVERFLOW_MODE			         
 	     ...
 	     - FAST_PWM_MODE
 =============================================================================================================*/
#define TIMER0_MODE PHASE_CORRECT_PWM_MODE /* Default: OVERFLOW_MODE */
...
/* Options : - DISCONNECTED				 
 ...
 =============================================================================================================*/
#define TIMER0_PHASE_CORRECT_PWM_OUTPUT_COMPARE_PIN_MODE NON_INVERTED_MODE /* Default : DISCONNECTED */
...
/* =============================================================================================================
 ...
 Options : - ENABLE
           - DISABLE
 =============================================================================================================*/
#define TIMER0_COMPARE_MATCH_INTERRUPT_ENABLE ENABLE /* Default : DISABLE */
...
/* =============================================================================================================
 ...
 =============================================================================================================*/
#define TIMER0_PRESCALER CLK_DIV_BY_64 /* Default: CLK_DIV_BY_8 */
